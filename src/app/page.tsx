        ...
        <section className="text-gray-600 border-b-2 border-gray-200 mx-28">
          ...
          <div className="flex justify-between mt-20">
            ...
            <div className="pt-20 w-[750px]">
              <h2 className="flex items-center text-6xl font-extrabold text-gray-700 pt-20">Saheb Chandok <IoMdHand className="text-yellow-500" /></h2>
              ...
              <p className="text-xl mt-5">I'm a Software Developer with over a year of experience in the IT industry. Currently I am pursuing Masters degree in Applied Computer Science from Concordia University,Canada. Feel free to explore my projects and get in touch.</p>
