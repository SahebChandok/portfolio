  ...
  return (
      <Timeline position={matches ? 'alternate' : 'right'}>
        <TimelineItem>
          ...
          <TimelineContent>
            <div className='flex bg-gray-100 p-6 rounded-lg border-gray-300 border-2 justify-start w-[500px] shadow-lg hover:shadow-2xl transition-shadow duration-300'>
        ...
        <TimelineItem>
          ...
          <TimelineContent >
            <div className='flex justify-end'>
              <div className='flex bg-gray-100 p-6 rounded-lg border-gray-300 border-2  w-[500px] shadow-lg hover:shadow-2xl transition-shadow duration-300'>
                <div className='items-center my-auto'>
